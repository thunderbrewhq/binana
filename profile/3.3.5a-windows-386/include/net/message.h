...
enum NETMESSAGE {
    ...
    CMSG_MOVE_CHARM_PORT_CHEAT                            = 0x00E0,
    ...
    CMSG_STAND_STATE_CHANGE                               = 0x0101,
    CMSG_EMOTE                                            = 0x0102,
    SMSG_EMOTE                                            = 0x0103,
    CMSG_SEND_TEXT_EMOTE                                  = 0x0104,
    SMSG_TEXT_EMOTE                                       = 0x0105,
    CMSG_AUTO_EQUIP_GROUND_ITEM                           = 0x0106,
    CMSG_AUTOSTORE_GROUND_ITEM                            = 0x0107,
    CMSG_AUTOSTORE_LOOT_ITEM                              = 0x0108,
    CMSG_STORE_LOOT_IN_SLOT                               = 0x0109,
    CMSG_AUTO_EQUIP_ITEM                                  = 0x010A,
    CMSG_AUTO_STORE_BAG_ITEM                              = 0x010B,
    CMSG_SWAP_ITEM                                        = 0x010C,
    CMSG_SWAP_INV_ITEM                                    = 0x010D,
    CMSG_SPLIT_ITEM                                       = 0x010E,
    CMSG_AUTO_EQUIP_ITEM_SLOT                             = 0x010F,
    CMSG_UNCLAIM_LICENSE                                  = 0x0110,
    ...
    CMSG_SET_FACTION_AT_WAR                               = 0x0125,
    ...
    CMSG_DEBUG_PASSIVE_AURA                               = 0x0140,
    CMSG_ATTACK_SWING                                     = 0x0141,
    ...
    MSG_MOVE_UPDATE_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY   = 0x034A,
    ...
    CMSG_BF_MGR_ENTRY_INVITE_RESPONSE                     = 0x04DF,
    SMSG_BATTLEFIELD_MGR_ENTERING                         = 0x04E0,
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                     = 0x04E1,
    CMSG_BF_MGR_QUEUE_INVITE_RESPONSE                     = 0x04E2,
    CMSG_BF_MGR_QUEUE_REQUEST                             = 0x04E3,
    ...
    CMSG_BF_MGR_QUEUE_EXIT_REQUEST                        = 0x04E7,
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                     = 0x04E8,
    CMSG_BATTLEFIELD_MANAGER_ADVANCE_STATE                = 0x04E9,
    CMSG_BATTLEFIELD_MANAGER_SET_NEXT_TRANSITION_TIME     = 0x04EA,
    ...
    CMSG_GM_TICKET_RESPONSE_RESOLVE                       = 0x04F0,
